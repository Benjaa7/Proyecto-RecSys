...
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **CPGRec (GNN)**         | `emb=32`, `lr=0,03`, `batch=1024`, `m=6,5` (margen NSR), `β=0,1`, `γ=80`, **1000 épocas**, `freeze_user_llm=0` (la 2.ª tabla de _embeddings_ de usuario es entrenable, como el repo original). Variantes: **base** (`--use_per 0 --use_llm 0`) · **+PER** (`--use_per 1`) · **+PER+PRG** (`--use_per 1 --use_llm 1`). |
